...
write.csv(age0length_pulse,"./data/output/age0_dummypulse.csv",row.names = FALSE)

write.csv(range_final,"./data/output/age0-pulse-range.csv",row.names = FALSE)
